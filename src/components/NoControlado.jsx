...
const NoControlado = () => { 
    ...
    const handleSubmit = (e) => {
        ...
        return setError("Es necesario completar todos los campos");
    ...
    return (
        <form onSubmit={handleSubmit} ref={form}>
            ...
            <textarea className="form-control mb-2" placeholder="Ingrese descripción" name="description" defaultValue="descripción #01"/>
